...
export type CartItemType = index.TProduct & { quantity: number };
...
export const useCartMutations = () => {
  ...
  const addToCart = (product: index.TProduct, quantity?: number) =>
    dispatch({
      type: "add",
      item: product,
      quantity,
  ...
  const removeFromCart = (product: index.TProduct) =>
    dispatch({
      type: "remove",
      item: product,
    });
